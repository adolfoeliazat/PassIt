...
User.destroy_all
User.create(:username => "11", :address => "212 Washington Ave Towson, MD 21204", :phone => "4339875612", :first_name => "Ahmad", :last_name => "Kaifi",:email => "1@1.1", :password => "11111111", :password_confirmation => "11111111", :remote_avatar_url => "https://pbs.twimg.com/profile_images/2592287481/image.jpg")
...
User.create(:username => "33", :address => "1149 Donington Circle Towson, MD 21204", :phone => "4104948800", :first_name => "Sidd", :last_name => "Kasa",:email => "3@3.3", :password => "33333333", :password_confirmation => "33333333", :remote_avatar_url => "http://triton.towson.edu/~skaza/wp-content/uploads/headshot.jpg")
